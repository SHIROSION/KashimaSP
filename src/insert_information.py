    ...
    def insert(self):
        ...
        while True:
            ...
            if len(information) <= 0:
                ...
                dbf = self.pro.query('balancesheet', ts_code="%s" % get_stock_information[0], start_date='', end_date='')
                cf = self.pro.query('cashflow', ts_code="%s" % get_stock_information[0], start_date='', end_date='')
                fc = self.pro.query('forecast', ts_code="%s" % get_stock_information[0], ann_date ='', start_date='', end_date='', period='20181231')
                ...
                fif = self.pro.query('fina_indicator', ts_code="%s" % get_stock_information[0], start_date='', end_date='', period='20181231')
                ...
                fc_forecast_file_path = "D://python project/teststock/data/%s_fc.csv" % ts_code
                ...
                while True:
                    ...
                    if len(cf) <= 0:
                        self.use_sql.insert_cashflow_data("%s_dbf" % ts_code, cashflow_data_list, cf_count - 1)
